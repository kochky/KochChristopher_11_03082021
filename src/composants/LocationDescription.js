    ...
    render() {
        ...
        return this.state.isOpen? (
            <div id="descriptionlocation" className="locationsmallcontainer ">
                <div className="titlecontainer small"><div className="title">Description</div><i style={{transform: 'rotate(180deg)'}}className="fas fa-chevron-down fa-lg" onClick={() => this.setState({isOpen:false})}></i></div>
