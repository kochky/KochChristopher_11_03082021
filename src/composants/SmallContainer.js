    ...
    return this.state.isOpen ? (
        <div className="smallcontainer">
            <div className="titlecontainer">
                ...
                <i style={{transform: 'rotate(180deg)'}}className="fas fa-chevron-down fa-lg" onClick={() => this.setState({isOpen:false})}></i>
            </div>
        ...
        <div className="smallcontainer">
            <div className="titlecontainer">
                <div className="title">{this.props.title}</div>
                <i style={{transform: 'rotate(0deg)'}}className="fas fa-chevron-down fa-lg" onClick={() => this.setState({isOpen:true})}></i>
            </div>
