    ...
    render(){
        ...
        return  this.state.isOpen?(
            <div className="locationsmallcontainer ">
                <div className="titlecontainer small"><div className="title">Equipements</div><i style={{transform: 'rotate(0deg)'}}className="fas fa-chevron-down fa-lg" onClick={() => this.setState({isOpen:false})}></i></div>
